...
function ConvarClass:InitULib() -- Server
...
function ConvarClass:GiveUIElement() -- Client
	if (self.type == "bool") then
...
function generateCVTable()
    tbl = tbl .. "[/table]"
    print(tbl)
end

function ConvarGroupClass:InitCustomVars() -- Server
...
function ConvarGroupClass:SetupULib() -- Client
    if CLIENT then
